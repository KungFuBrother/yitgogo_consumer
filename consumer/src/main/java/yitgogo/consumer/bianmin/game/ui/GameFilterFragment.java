...
public class GameFilterFragment extends BaseNotifyFragment {
    ...
    private void getGames() {
        ...
        request.setUrl(API.API_BIANMIN_GAME_LIST);
    ...
    private void getGameArea() {
        Request request = new Request();
        request.setUrl(API.API_BIANMIN_GAME_AREA);
        request.addRequestParam("gameid", game.getId());
        MissionController.startRequestMission(getActivity(), request, new RequestListener() {
            @Override
            protected void onStart() {
                showLoading();
    ...
    private void getGameServer() {
        Request request = new Request();
        request.setUrl(API.API_BIANMIN_GAME_SERVER);
        request.addRequestParam("gameid", game.getId());
        request.addRequestParam("area", gameArea
                .getArea());
        MissionController.startRequestMission(getActivity(), request, new RequestListener() {
            @Override
            protected void onStart() {
