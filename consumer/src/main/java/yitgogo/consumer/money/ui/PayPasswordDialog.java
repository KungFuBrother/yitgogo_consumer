...
public class PayPasswordDialog extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        LayoutParams layoutParams = new LayoutParams(ScreenUtil.getScreenWidth(), ScreenUtil.getScreenWidth());
    ...
    private void findViews() {
        ...
        titleLayout = (LinearLayout) dialogView.findViewById(R.id.password_title_layout);
        titleTextView = (TextView) dialogView.findViewById(R.id.password_title_lable);
        passwordLayout = (LinearLayout) dialogView.findViewById(R.id.password_code_layout);
        loadingLayout = (LinearLayout) dialogView.findViewById(R.id.password_loading_layout);
        deleteButton = (TextView) dialogView.findViewById(R.id.password_input_delete);
        okButton = (TextView) dialogView.findViewById(R.id.password_input_ok);
        for (int i = 0; i < passwordViewIds.length; i++) {
            passwordViews.add((PasswordView) dialogView.findViewById(passwordViewIds[i]));
        }
        for (int i = 0; i < inputNumberIds.length; i++) {
            inputNumbers.add((TextView) dialogView.findViewById(inputNumberIds[i]));
        }
        initViews();
    }
